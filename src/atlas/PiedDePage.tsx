 ...
 * telephone : Calendrier, News, Styles, Mixtapes, Tracks, le profil. L'index
 * a plat des 219 genres part avec eux et rejoint la page des styles, d'ou on
 * le cherche vraiment.
 *
...
export function PiedDePage() {
  ...
  /* AU CENTRE, CE QU'ON NE TROUVE PAS DANS LE MENU. Les sections du site,
     Calendrier, News, Styles, Mixtapes, Tracks, sont toutes dans la rangee du
     haut ou dans le bouton « Plus » du telephone : les redire ici doublait
     seize liens sans en ajouter un seul. Le micro, lui, n'a jamais eu de lien
     ici et n'en prend pas : il s'ouvre depuis le haut de l'atlas. Restent les deux gestes de
